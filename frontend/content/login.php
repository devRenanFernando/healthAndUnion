...
<body>
    ...
    <section id="registration" class="container-flex min-vh-100 d-flex align-items-center justify-content-center ">
        <div class="w-75">
            <div id="second-content" class="row content py-5 w-75 d-flex align-items-center mx-auto">

                <div class="first-column col-lg-4 col-12 text-center text-light order-last">
                    <h2 class="fs-2 text-capitalize">Olá, Amigo!</h2>
                    <p class="fw-light">Digite seus dados pessoais</p>
                    <a href="registration.php">
                        <button id="signin" class="btn btn-outline-primary fw-bold px-5">Sign up</button>
                    </a>
                ...
                <div class="second-column col-lg-8 col-12 text-center text-dark order-first">
                    ...
                    <form class="form d-flex flex-column">
                        ...
                        <button class="btn btn-outline-secondary fw-bold w-50 mx-auto mt-4">Sign in</button>
